...
const CONFIG = {
    MAX_HTML_SIZE: 10 * 1024 * 1024, // Reduced to 5MB max HTML size
    MAX_CONTENT_LENGTH: 35 * 1024 * 1024, // Reduced to 20MB max content length
    REQUEST_TIMEOUT: 45000, // Reduced to 30 seconds
    ANALYSIS_TIMEOUT: 70000, // Reduced to 45 seconds for analysis
    MAX_DOM_ELEMENTS: 5000, // Reduced maximum DOM elements to analyze
    MEMORY_LIMIT_MB: 400, // Reduced memory limit
